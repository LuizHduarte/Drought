...
rio_pardo_de_mg_model.use_neural_network(True, 'Rio Pardo de Minas')

francisco_sá_dataset    = Dataset('Francisco Sá', './Data/', 'spei12_FranciscoSá.xlsx')
francisco_sá_plotter    = Plotter(francisco_sá_dataset)

rio_pardo_de_mg_model.use_neural_network(False, 'Rio Pardo de Minas', 'Francisco Sá', dataset=francisco_sá_dataset, plotter=francisco_sá_plotter)